...
class BackendBaseSettings(BaseSettings):
    ...
    OPENAI_API_KEY: str = decouple.config("OPENAI_API_KEY", cast=str)  # type: ignore
    LANGFUSE_PUBLIC_KEY: str = decouple.config("LANGFUSE_PUBLIC_KEY", cast=str)  # type: ignore
    LANGFUSE_SECRET_KEY: str = decouple.config("LANGFUSE_SECRET_KEY", cast=str)  # type: ignore
    LANGFUSE_HOST: str = decouple.config("LANGFUSE_HOST", cast=str)  # type: ignore
    GOOGLE_CLIENT_ID: str = decouple.config("GOOGLE_CLIENT_ID", cast=str)  # type: ignore
    GOOGLE_CLIENT_SECRET: str = decouple.config("GOOGLE_CLIENT_SECRET", cast=str)  # type: ignore
